...
Este documento describe las funcionalidades que desarrollaremos en el proyecto **ROE DuPont Interactivo**, utilizando **WindsurfAI** como entorno de desarrollo.  
...
Este enfoque permite practicar no solo la programación con **Python, Streamlit y Plotly**, sino también la organización profesional de un proyecto de desarrollo con **Windsurf AI**.
